...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-menu">
        ...
        @if($currentSection === 'admin')
            <!-- ADMIN SECTION -->
            <h3>Admin</h3>
            <li><a href="/admin" class="@if(request()->is('admin') || request()->is('admin/analytics')) active @endif"><span class="icon"><i class="fas fa-tachometer-alt"></i></span><span class="label">Dashboard</span></a></li>
            ...
            <li><a href="/admin/analytics" class="@if(request()->is('admin/analytics')) active @endif"><span class="icon"><i class="fas fa-chart-line"></i></span><span class="label">Analytics</span></a></li>

        @elseif($currentSection === 'coach')
            <!-- COACH SECTION -->
            <h3>Coach</h3>
            <li><a href="/coach" class="@if(request()->is('coach') || request()->is('coach/training-logs')) active @endif"><span class="icon"><i class="fas fa-tachometer-alt"></i></span><span class="label">Dashboard</span></a></li>
