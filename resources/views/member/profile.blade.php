...
@section('content')
    <div class="page">
            ...
            <div class="section-body">
                <div class="info-grid">
                    <div class="info-item">
                        ...
                        <div class="info-value" id="infoName">{{ $user->first_name }} {{ $user->last_name }}</div>
                    </div>
                    <div class="info-item">
        ...
        <div class="card section-card">
            ...
            <form method="POST" action="{{ route('member.profile.update') }}" class="section-body">
                @csrf
                <div class="info-grid">
                    <div class="info-item">
        ...
        <div class="card section-card">
            ...
            <form method="POST" action="{{ route('member.password.update') }}" class="section-body">
                @csrf
                <div class="info-grid">
                    <div class="info-item">
            ...
            <form method="POST" action="{{ route('member.profile.update') }}">
                ...
                <div class="modal-grid">
                    <div class="modal-field" style="grid-column: span 2;">
                        ...
                        <input type="text" id="inputFullName" name="full_name" value="{{ $user->first_name }} {{ $user->last_name }}">
                    </div>
                ...
                <div class="modal-actions">
                    <button type="button" class="btn-cancel" id="cancelInfoModal">Cancel</button>
                    <button type="submit" class="btn-save">Save Changes</button>
                </div>
            </form>
        </div>
